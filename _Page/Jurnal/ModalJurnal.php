            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-12 text-center">
                        <b>Keterangan</b><br>
                        <small>
                            Untuk membuat jurnal keuangan pada aplikasi ini umumnya dilakukan melalui proses transaksi (Simpannan, Pinjaman, Penarikan, Angsuran, Transaksi, dll)
                            yang sudah terintegrasi dengan pengaturan masing-masing jenis transaksi tersebut.<br>
                            Namun anda masih bisa menambahkan/membuat jurnal keuangan secara manual baik dengan kode referensi transaksi atau tidak. 
                            Anda akan diarahkan ke halaman form tambah data jurnal dengan memilih tombol 'Lanjutkan' berikut ini.
                        </small>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <a href="index.php?Page=Jurnal&Sub=TambahJurnal" class="btn btn-md btn-success btn-rounded">
