    ...
    if($SessionKategoriAkses=="Anggota"){
        ...
        if($SessionKategoriAkses=="Supervisi"){
            ...
            if($SessionKategoriAkses=="Mitra"){
                $SessionGambar=GetDetailData($Conn,'mitra','id_mitra',$SessionIdAkses,'foto');
                $SessionNama=GetDetailData($Conn,'mitra','id_mitra',$SessionIdAkses,'nama');
                $SessionKontakAkses=GetDetailData($Conn,'mitra','id_mitra',$SessionIdAkses,'kontak');
                $SessionEmailAkses=GetDetailData($Conn,'mitra','id_mitra',$SessionIdAkses,'email');
                $SessionAkses=$SessionKategoriAkses;
            }else{
                //Admin
