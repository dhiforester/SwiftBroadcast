<aside id="sidebar" class="sidebar menu_background">
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link <?php if($PageMenu!=="KontakMitra"){echo "collapsed";} ?>" href="index.php?Page=KontakMitra">
        ...
        <li class="nav-item">
            <a class="nav-link <?php if($PageMenu!=="KomisiMitra"){echo "collapsed";} ?>" href="index.php?Page=KomisiMitra">
